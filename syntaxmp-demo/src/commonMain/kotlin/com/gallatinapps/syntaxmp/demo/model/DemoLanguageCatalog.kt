...
internal object DemoLanguageCatalog {
    ...
    val Languages: List<DemoLanguage> = listOf(
        ...
        DemoLanguage(
            ...
            aliases = listOf("env", "properties"),
            sample = IniSample,
        ),
        DemoLanguage(
            id = SyntaxLanguageId.Json5,
            displayName = "JSON5",
            sample = Json5Sample,
        ),
        DemoLanguage(
        ...
        DemoLanguage(
            id = SyntaxLanguageId.Terraform,
            displayName = "Terraform",
            aliases = listOf("tf"),
            sample = TerraformSample,
        ),
        DemoLanguage(
            id = SyntaxLanguageId.Hcl,
            displayName = "HCL",
            sample = HclSample,
        ),
        DemoLanguage(
        ...
        DemoLanguage(
            id = SyntaxLanguageId.Glsl,
            displayName = "GLSL",
            aliases = listOf("frag", "vert"),
            sample = GlslSample,
        ),
        DemoLanguage(
            id = SyntaxLanguageId.ApacheConf,
            displayName = "Apache Config",
            aliases = listOf("htaccess"),
            sample = ApacheConfSample,
        ),
        DemoLanguage(
            id = SyntaxLanguageId.DnsZone,
            displayName = "DNS Zone",
            aliases = listOf("bind", "zone"),
            sample = DnsZoneSample,
        ),
        DemoLanguage(
            id = SyntaxLanguageId.ObjectiveC,
            displayName = "Objective-C",
            aliases = listOf("objc"),
            sample = ObjectiveCSample,
        ),
        DemoLanguage(
            id = SyntaxLanguageId.Lua,
            displayName = "Lua",
            sample = LuaSample,
        ),
        DemoLanguage(
            id = SyntaxLanguageId.R,
            displayName = "R",
            sample = RSample,
        ),
        DemoLanguage(
            id = SyntaxLanguageId.Scala,
            displayName = "Scala",
            aliases = listOf("sc"),
            sample = ScalaSample,
        ),
        DemoLanguage(
            id = SyntaxLanguageId.Elixir,
            displayName = "Elixir",
            aliases = listOf("ex"),
            sample = ElixirSample,
        ),
        ...
        DemoLanguage(
            id = SyntaxLanguageId.Groovy,
            displayName = "Groovy",
            aliases = listOf("gvy", "gy", "gradle", "gradle.groovy", "build.gradle"),
            sample = GroovySample,
        ),
        DemoLanguage(
        ...
        DemoLanguage(
            id = SyntaxLanguageId.Mdx,
            displayName = "MDX",
            sample = MdxSample,
        ),
        DemoLanguage(
            id = SyntaxLanguageId.Vue,
            displayName = "Vue",
            sample = VueSample,
        ),
        DemoLanguage(
            id = SyntaxLanguageId.Svelte,
            displayName = "Svelte",
            sample = SvelteSample,
        ),
        DemoLanguage(
            id = SyntaxLanguageId.Astro,
            displayName = "Astro",
            sample = AstroSample,
        ),
        DemoLanguage(
            ...
            displayName = "Shell",
            aliases = listOf("bash", "zsh"),
            sample = ShellSample,
        ),
        DemoLanguage(
            id = SyntaxLanguageId.Scss,
            displayName = "SCSS",
            sample = ScssSample,
        ),
        DemoLanguage(
            id = SyntaxLanguageId.Less,
            displayName = "Less",
            sample = LessSample,
        ),
        DemoLanguage(
