...
internal val GeneralSourceFixtures: List<LanguageBenchmarkFixture> =
    listOf(
        ...
        ObjectiveCRepresentativeFixture,
        GoRepresentativeFixture,
        RustRepresentativeFixture,
        DartRepresentativeFixture,
        GroovyRepresentativeFixture,
        ScalaRepresentativeFixture,
        LuaRepresentativeFixture,
        RRepresentativeFixture,
        ElixirRepresentativeFixture,
        PerlRepresentativeFixture,
