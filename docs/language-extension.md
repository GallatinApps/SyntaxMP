...
- [docs/embedded-languages.md](embedded-languages.md): what SyntaxMP routes automatically (HTML script/style, Markdown fences, JSX/TSX) and what it deliberately doesn't.
- [docs-internal/adding-a-built-in-language.md](../docs-internal/adding-a-built-in-language.md): the maintainer-facing SOP for contributing a built-in tokenizer back to the library.
