...
- [docs/embedded-languages.md](embedded-languages.md): what gets routed to which embedded language automatically inside HTML, Markdown, JSX/TSX/MDX, Vue, Svelte, and Astro.
